...
var LessonView = (_dec = (0, _redux.connect)(mapStateToProps), _dec(_class = (_temp2 = _class2 = function (_Taro$PureComponent) {
  ...
  function LessonView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LessonView.__proto__ || Object.getPrototypeOf(LessonView)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "$compid__31", "$compid__32", "$compid__33", "$compid__34", "$compid__35", "mode", "dispatch", "videos", "current"], _this.config = {
      enablePullDownRefresh: true
    }, _this.state = {
      mode: 'video'
    }, _this.customComponents = ["VideoPlayer", "AtTabs", "AtTabsPane", "LessonHome"], _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(LessonView, [{
    key: '_constructor',
    value: function _constructor(props) {
      _get(LessonView.prototype.__proto__ || Object.getPrototypeOf(LessonView.prototype), '_constructor', this).call(this, props);
    ...
    value: function _createData() {
      ...
      var tabList = [{ title: '简介' }, { title: '作业' }, { title: '笔记' }];
      var anonymousState__temp = this.__props.videos ? (0, _lodashEs.get)(this.__props, 'videos', null) : null;
      var anonymousState__temp2 = this.__props.videos ? (0, _lodashEs.get)(this.__props, 'videos.token.pick_code', null) : null;
      var anonymousState__temp3 = this.__props.videos ? (0, _lodashEs.get)(this.__props, 'videos.token.file_hash', null) : null;
      this.__props.videos && _taroWeapp.propsManager.set({
        "lessonVideo": anonymousState__temp,
        "lessonId": this.$router.params.lid,
        "pick_code": anonymousState__temp2,
        "file_hash": anonymousState__temp3
