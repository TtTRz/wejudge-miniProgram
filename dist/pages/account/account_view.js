...
var AccountView = (_temp2 = _class = function (_Taro$PureComponent) {
  ...
  function AccountView() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AccountView.__proto__ || Object.getPrototypeOf(AccountView)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "$compid__14", "$compid__15", "$compid__16", "current", "accountMessage"], _this.config = {
      enablePullDownRefresh: true
    }, _this.state = {}, _this.customComponents = ["AtAvatar", "AtList", "AtListItem"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(AccountView, [{
    ...
    value: function _createData() {
      ...
      var anonymousState__temp = buildResourcePath(this.__props.accountMessage.avator);
      var anonymousState__temp2 = Role(this.__props.accountMessage.role);
